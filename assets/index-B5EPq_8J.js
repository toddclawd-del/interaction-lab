import{j as e,J as g,V as d,w as m}from"./three-vendor-kjlaQlG4.js";import{r as i}from"./react-vendor-DWqy1xEj.js";import{R as y,u as p}from"./ResponsiveShader-DyR4yBmq.js";const D=`
...
`,f={ripple:0,wave:1,twist:2,bulge:3,noise:4};function w({textureUrl:s,mode:t,intensity:n}){const u=i.useRef(null),{mouse:o,scroll:r,isHovered:l}=p(),a=g(s),c=i.useRef(0),v=i.useRef({uTime:{value:0},uMouse:{value:new d(.5,.5)},uTexture:{value:a},uHover:{value:0},uScrollProgress:{value:0},uDistortionMode:{value:f[t]},uIntensity:{value:n}});return m(({clock:x})=>{v.current.uTime.value=x.getElapsedTime(),v.current.uMouse.value.lerp(o,.1),v.current.uScrollProgress.value=r,c.current+=(l?1:0-c.current)*.08,v.current.uHover.value=c.current}),i.useEffect(()=>{v.current.uDistortionMode.value=f[t]},[t]),i.useEffect(()=>{v.current.uTexture.value=a},[a]),e.jsxs("mesh",{ref:u,children:[e.jsx("planeGeometry",{args:[2,2]}),e.jsx("shaderMaterial",{vertexShader:h,fragmentShader:D,uniforms:v.current})]})}function T({mode:s,intensity:t}){const n=i.useRef(null),{mouse:u,isHovered:o}=p(),r=i.useRef(0),l=i.useRef({uTime:{value:0},uMouse:{value:new d(.5,.5)},uHover:{value:0},uDistortionMode:{value:f[s]},uIntensity:{value:t}});return m(({clock:a})=>{l.current.uTime.value=a.getElapsedTime(),l.current.uMouse.value.lerp(u,.1),r.current+=(o?1:0-r.current)*.08,l.current.uHover.value=r.current}),e.jsxs("mesh",{ref:n,children:[e.jsx("planeGeometry",{args:[2,2]}),e.jsx("shaderMaterial",{vertexShader:h,fragmentShader:M,uniforms:l.current})]})}function R({src:s,alt:t="Distorted image",mode:n="ripple",intensity:u=1,className:o="",style:r}){const[l,a]=i.useState(!1);return e.jsx("div",{className:o,style:{position:"relative",width:"100%",height:"100%",minHeight:"300px",overflow:"hidden",borderRadius:"8px",...r},onMouseEnter:()=>a(!0),onMouseLeave:()=>a(!1),role:"img","aria-label":t,children:e.jsx(y,{trackMouse:!0,mobileInteraction:"touch",pauseWhenHidden:!0,frameloop:l?"always":"demand",children:s?e.jsx(w,{textureUrl:s,mode:n,intensity:u}):e.jsx(T,{mode:n,intensity:u})})})}function b({images:s,columns:t=3,gap:n="1rem",className:u=""}){return e.jsx("div",{className:u,style:{display:"grid",gridTemplateColumns:`repeat(${t}, 1fr)`,gap:n},children:s.map((o,r)=>e.jsx(R,{src:o.src,alt:o.alt,mode:o.mode||"ripple",style:{aspectRatio:"1"}},r))})}export{b as DistortionGallery,R as ShaderDistortion,R as default};
