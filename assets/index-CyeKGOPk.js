import{r as f,j as e}from"./index-CUd0y5HU.js";import{R as j,u as A}from"./ResponsiveShader-cFA4YkFk.js";import{s as C,v as R,k as w,I as P,C as g,V as k}from"./react-three-fiber.esm-Cp6QJBNm.js";class I extends w{constructor(){super({uniforms:{uTime:{value:0},uMouse:{value:new k(.5,.5)},uMouseStrength:{value:.5},uMouseRadius:{value:.2},uAttractionMode:{value:0},uColor1:{value:new g("#667eea")},uColor2:{value:new g("#764ba2")},uSize:{value:2},uSpeed:{value:.1}},vertexShader:`
