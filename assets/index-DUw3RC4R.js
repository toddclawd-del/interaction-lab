import{j as t,u as x,C as n,V as v,w as d}from"./three-vendor-BRQK_L2F.js";import{r as u}from"./react-vendor-DWqy1xEj.js";import{R as h,u as p}from"./ResponsiveShader-BbfjpCaq.js";const C=`
...
`;function w({colors:e,speed:r=.2,noiseScale:s=2,mouseInfluence:l=.3}){const a=u.useRef(null),{viewport:i}=x(),{mouse:c}=p(),o=u.useRef({uTime:{value:0},uMouse:{value:new v(.5,.5)},uResolution:{value:new v(i.width,i.height)},uColor1:{value:new n(e[0])},uColor2:{value:new n(e[1])},uColor3:{value:new n(e[2])},uColor4:{value:new n(e[3])},uSpeed:{value:r},uNoiseScale:{value:s},uMouseInfluence:{value:l}});return d(({clock:f})=>{o.current.uTime.value=f.getElapsedTime(),o.current.uMouse.value.lerp(c,.05)}),u.useEffect(()=>{o.current.uResolution.value.set(i.width,i.height)},[i]),u.useEffect(()=>{o.current.uColor1.value.set(e[0]),o.current.uColor2.value.set(e[1]),o.current.uColor3.value.set(e[2]),o.current.uColor4.value.set(e[3])},[e]),t.jsxs("mesh",{ref:a,children:[t.jsx("planeGeometry",{args:[2,2]}),t.jsx("shaderMaterial",{vertexShader:g,fragmentShader:C,uniforms:o.current})]})}const b={aurora:["#0f0c29","#302b63","#24243e","#0f0c29"],sunset:["#ff6b6b","#feca57","#ff9ff3","#ff6b6b"],ocean:["#0077b6","#00b4d8","#90e0ef","#caf0f8"],forest:["#1a472a","#2d5a27","#4a7c59","#8eb486"],candy:["#ff0080","#ff8c00","#40e0d0","#ff0080"],midnight:["#0c0c0c","#1a1a2e","#16213e","#1a1a2e"],neon:["#f72585","#7209b7","#3a0ca3","#4cc9f0"],earth:["#8B4513","#D2691E","#CD853F","#DEB887"]};function m({colors:e,preset:r="aurora",speed:s=.2,noiseScale:l=2,mouseInfluence:a=.3,className:i="",style:c,children:o}){const f=e||b[r];return t.jsxs("div",{className:i,style:{position:"relative",width:"100%",height:"100%",minHeight:"200px",...c},children:[t.jsx("div",{style:{position:"absolute",inset:0},children:t.jsx(h,{trackMouse:!0,mobileInteraction:"scroll",pauseWhenHidden:!0,children:t.jsx(w,{colors:f,speed:s,noiseScale:l,mouseInfluence:a})})}),o&&t.jsx("div",{style:{position:"relative",zIndex:1,height:"100%"},children:o})]})}function M({children:e,...r}){return t.jsx(m,{...r,style:{height:"100vh",display:"flex",alignItems:"center",justifyContent:"center",color:"white",...r.style},children:e})}function U({height:e=200,...r}){return t.jsx(m,{...r,mouseInfluence:.1,style:{height:`${e}px`,...r.style}})}export{U as GradientDivider,M as GradientHero,m as ShaderGradient,m as default,b as gradientPresets};
