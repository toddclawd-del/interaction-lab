...
export function GlassmorphismButton({ children, className = '', onClick }: ButtonProps) {
  ...
  return (
    <motion.button
      ...
      className={`
        relative px-12 py-4 rounded-2xl font-semibold text-white
...
export function NeumorphicButton({ children, className = '', onClick }: ButtonProps) {
  ...
  return (
    <motion.button
      ...
      className={`
        relative px-12 py-4 rounded-2xl font-semibold
...
export function GhostOutlineButton({ children, className = '', onClick }: ButtonProps) {
  ...
  return (
    <motion.button
      ...
      whileTap={prefersReducedMotion ? {} : { scale: 0.98 }}
      className={`
        relative px-12 py-4 rounded-xl font-semibold
...
export function LayeredDepthButton({ children, className = '', onClick }: ButtonProps) {
  ...
  return (
    ...
    >
      ...
      {/* Top layer (main) */}
      <motion.span
        className="relative block px-12 py-4 rounded-xl font-semibold text-white"
        style={{ backgroundColor: 'var(--color-primary)' }}
        variants={{ hover: { y: -2 } }}
        transition={{ type: 'spring', stiffness: 400, damping: 25 }}
      >
...
export function LiquidMetalButton({ children, className = '', onClick }: ButtonProps) {
  ...
  return (
    <motion.button
      ...
      whileTap={prefersReducedMotion ? {} : { scale: 0.98 }}
      className={`
        relative px-12 py-4 rounded-2xl font-bold text-neutral-800
        min-h-[56px] overflow-hidden
...
export function MorphingBlobButton({ children, className = '', onClick }: ButtonProps) {
  ...
  return (
    ...
    >
      ...
      <span className="relative z-10 px-12 py-4 text-white font-semibold block">
        {children}
      </span>
    </motion.button>
  )
...
export function CyberpunkNeonButton({ children, className = '', onClick }: ButtonProps) {
  ...
  return (
    <motion.button
      ...
      whileTap={prefersReducedMotion ? {} : { scale: 0.98 }}
      className={`
        relative px-12 py-4 font-bold uppercase tracking-wider
...
export function TextScrambleButton({ children, className = '', onClick }: ButtonProps) {
  ...
  return (
    <motion.button
      ...
      whileTap={prefersReducedMotion ? {} : { scale: 0.98 }}
      className={`
        relative px-12 py-4 rounded-xl font-mono font-bold
...
export function BorderFlowButton({ children, className = '', onClick }: ButtonProps) {
  ...
  return (
    <motion.button
      ...
      whileTap={prefersReducedMotion ? {} : { scale: 0.98 }}
      className={`
        relative px-12 py-4 rounded-xl font-semibold text-white
...
export function PillIndicatorButton({ children, className = '', onClick }: ButtonProps) {
  ...
  return (
    <motion.button
      ...
      whileTap={prefersReducedMotion ? {} : { scale: 0.98 }}
      className={`
        relative flex items-center gap-4 pl-10 pr-4 py-3 
...
export function PillGradientButton({ children, className = '', onClick }: ButtonProps) {
  ...
  return (
    <motion.button
      ...
      whileTap={prefersReducedMotion ? {} : { scale: 0.98 }}
      className={`
        relative px-12 py-4 rounded-full font-semibold text-white
        min-h-[56px] overflow-hidden
        ${className}
      `}
      style={{
